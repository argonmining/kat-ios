class MockDataProvider: DataProvidable {
    ...
    private var addresses: [AddressModel] = [
        .init(address: "kaspa:qpq6lt496v9lvcmc744hfe5m6cl5e33qfuasmjq205gsf50xjm2nwy9er5h56", contentTypes: [.tokens, .nfts]),
        .init(address: "kaspa:qpz2vgvlxhmyhmt22h538pjzmvvd52nuut80y5zulgpvyerlskvvwm7n4uk5a", contentTypes: [.tokens, .nfts])
    ]
